...
if __name__=="__main__":
    ...
    parser.add_argument('--data_names', nargs='+', type=str, default=["HDPE", "LDPE", "PET"], help='input .npy file names')
    ...
    parser.add_argument('--train_perc', default=80, type=float, help='percent used as training dataset')
    parser.add_argument('--val_perc', default=20, type=float, help='percent used as training dataset')
