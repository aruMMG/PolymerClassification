...
if __name__=="__main__":
    ...
    parser.add_argument('--data_names', nargs='+', type=str, default=["W_S2_PE", "W_S2_PET", "W_S2_PP"], help='input .npy file names')
    ...
    parser.add_argument('--train_perc', default=70, type=float, help='percent used as training dataset')
    parser.add_argument('--val_perc', default=15, type=float, help='percent used as training dataset')
    parser.add_argument('--test_perc', default=15, type=float, help='percent used as training dataset')
