...
if __name__=="__main__":
    ...
    parser.add_argument('--fold_name', type=str, default='7', help='input data directoy containing .npy files')
    parser.add_argument('--weight', type=str, default="./logFile/EXP6/c/FC_baseline/last_7.pt", help='input data directoy containing .npy files')
    ...
    dataset_val = IRDatasetFromNames(dataarrayX_val, dataarrayY_val, data_number_val, FC=True)    
