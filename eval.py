...
if __name__=="__main__":
    ...
    parser.add_argument('--log_name', type=str, default='exp14_test_W_S_C5', help='Read and Save log file name')
    ...
    parser.add_argument('--arg_file', type=str, default='logFile/exp14_test_W_S_C5/arguments.txt', help='input argument .txt file')
...
# Transformer Hyp
    ...
    for fold_name in os.listdir(f'logFile/{args.log_name}/data_split'):
        ...
        weight_path = args.weight_folder
        if args.baseline:
            weight_path = weight_path + "_baseline"

        weight_path = os.path.join("logFile", args.log_name, weight_path, "best_" + str(args.fold_num) + ".pt")
